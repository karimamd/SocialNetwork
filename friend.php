...
$results=0;
$var=$_POST['result'];
    $query2=$link->query("(Select Fname, Lname, ProfilePic from Profile INNER JOIN Friend ON Profile.ProfileID= Friend.ProfileID_2 where Friend.ProfileID_1=".$_SESSION['ProfileID'] .") UNION
(Select Fname, Lname, ProfilePic from Profile INNER JOIN Friend ON Profile.ProfileID= Friend.ProfileID_1 where Friend.ProfileID_2=".$_SESSION['ProfileID'] .")" );
//or  or
       //
       ...
       if($capt[2]) echo '<img height="40" width="40" style="margin-right:0.5em;vertical-align:middle;border-radius:50%" src="data:image/png;base64,'.base64_encode( $capt[3] ).'"/>';
